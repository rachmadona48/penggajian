...
<script type="text/javascript">
    ...
    function tabelPTT13(){
        ...
        var dataTable = $('#tableptt13').DataTable( {
                ...
                "ajax":{
                    url :"<?php echo site_url('/admin/batch/dataPTT13')?>", // json datasource
                    type: "post",  // method  , by default get
                    // drawCallback: function( settings ) {
    ...
    function tabelTPP(){
        ...
        var dataTable = $('#tabletpp').DataTable( {
                ...
                "ajax":{
                    url :"<?php echo site_url('/admin/batch/dataTPP')?>", // json datasource
                    type: "post",  // method  , by default get
                    // drawCallback: function( settings ) {
    ...
    function tabelTPP13(){
        ...
        var dataTable = $('#tabletpp13').DataTable( {
                ...
                "ajax":{
                    url :"<?php echo site_url('/admin/batch/dataTPP13')?>", // json datasource
                    type: "post",  // method  , by default get
                    // drawCallback: function( settings ) {
    ...
    function exc_ptt_13_2(th13,thblptt13){
        $.ajax({
            url: '<?php echo base_url("/admin/batch/exc_ptt_13") ?>',
            type: "post",
    ...
    function cek_thbl_tpp(thbltpp){
        $.ajax({
            url: '<?php echo base_url("/admin/batch/cek_tpp1") ?>',
            type: "post",
    ...
    function execute_tpp1(thbltpp){
        $.ajax({
            url: '<?php echo base_url("/admin/batch/execute_tpp1") ?>',
            type: "post",
            data: {thbltpp:thbltpp},
            dataType: "JSON",
            beforeSend: function(){
    ...
    function exc_tpp_2(thbltpp){
        $.ajax({
            url: '<?php echo base_url("/admin/batch/execute_tpp2") ?>',
            type: "post",
            data: {thbltpp:thbltpp},
            dataType: "JSON",
            beforeSend: function(){
    ...
    function cek_th_tpp13(th,thbltpp13){
        $.ajax({
            url: '<?php echo base_url("/admin/batch/cek_tpp13") ?>',
            type: "post",
            data: {th:th},
            dataType: "JSON",
            beforeSend: function(){
    ...
    function execute_tpp13(th,thbltpp13){
        $.ajax({
            url: '<?php echo base_url("/admin/batch/execute_tpp13") ?>',
            type: "post",
    ...
    function cetak_gajiPTT(){
        var thbl_ptt = $('#thblptt').val();
        $.ajax({
            url : '<?php echo base_url("/admin/batch/cek_gj_ptt") ?>',
            type: "post",
            ...
            success : function(data){
                ...
                if(data.respone=='sukses'){
                    ...
                    window.open('/admin/Batch/printGAJI_ptt');
                    // reload_tglBatch();
                }else{
    ...
    function cetak_gajiTPP_PTT(){
        var thbltpp = $('#thbltpp').val();
        $.ajax({
            url : '<?php echo base_url("/admin/batch/cek_TPP_PTT") ?>',
            type: "post",
            data: {thbltpp:thbltpp},
            dataType: "JSON",
            ...
            success : function(data){
                ...
                if(data.respone=='sukses'){
                    // alert("sukses");
                    //cetak_gajiTXT2(tgl_batch3);
                    window.open('/admin/Batch/print_TPP_PTT');
                    // reload_tglBatch();
                }else{
