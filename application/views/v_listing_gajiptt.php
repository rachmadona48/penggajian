                        ...
                        <div class="col-md-12">
                                    ...
                                    <select class="form-control chosen-jenis" name="jenis" id="jenis" data-placeholder="Cari Berdasarkan...">
                                    	<?php if($user_group == 52) { ?> <!-- jika group adalah skpd -->
											<?php if($spmu == 'C040' || $spmu == 'C041') { ?> <!-- disdik-->
						                    	...
						                    	<option value="5">Listing Gaji PTT </option>
												<option value="6">Rekap Gaji PTT </option>
					                		<?php }elseif ($spmu == 'C030' || $spmu == 'C031') { ?> <!-- dinkes-->
					                			<option value="0">Pilih Jenis Listing</option>
												<option value="7">Listing Gaji PTT </option>
												<option value="8">Listing Gaji PTT </option>
					                		<?php }else{ ?> 
					                			<option value="0">Pilih Jenis Listing</option>
												<option value="3">Listing Gaji PTT </option>
												<option value="4">Rekap Gaji PTT </option>	
					                		<?php } ?>

                                    		
										<?php }else{ ?>
											<option value="0">Pilih Jenis Listing</option>
	                                        <option value="1">Listing Gaji PTT Gab </option>   
											<option value="2">Rekap Gaji PTT Gab </option> 	
                                        <?php } ?>
                                    </select>
                                </div>   
                            ...
                            <br/><br/>  <div class="col-md-10">
                                ...
                                <div id="paramval1" style="display: none">
                                    ...
                                    <div class="col-md-4">
                                        <select class="form-control chosen-thbl" name="thbl1" id="thbl1" tabindex="2" data-placeholder="Pilih inputan..." >
                                            <option value=""></option>
                                                <?php echo $getTHBLListinggajiptt; ?>
                                        </select>
                                    </div>
                                    <div class="col-md-3">
                                        <a onclick="cetaklistinggajiptt(); return false;" id="btnPdf" class="btn btn-danger"><i class="fa fa-file-pdf-o"></i> Cetak</a>
                                    </div>
                                </div>   
                                <!-- END Listing Gaji PTT Gab -->
                                ...
                                <div id="paramval2" style="display: none">
                                    ...
                                    <div class="col-md-3">
                                        <a onclick="cetakrekapgajipttgab(); return false;" id="btnPdf" class="btn btn-danger"><i class="fa fa-file-pdf-o"></i> Cetak</a>
                                    </div>
                                </div>   
                                <!-- END Rekap Gaji PTT Gab-->
								
								<!--Listing Gaji PTT SPMU -->
                                <div id="paramval3" style="display: none">
                                    ...
                                    <div class="col-md-3">
                                        <a onclick="cetaklistinggajipttspm(); return false;" id="btnPdf" class="btn btn-danger"><i class="fa fa-file-pdf-o"></i> Cetak</a>
                                    </div>
                                </div>    
                                <!-- Listing Gaji PTT SPMU-->
                                ...
                                <div id="paramval4" style="display: none">
                                    ...
                                    <div class="col-md-3">
                                        <a onclick="cetakrekapgajipttspm(); return false;" id="btnPdf" class="btn btn-danger"><i class="fa fa-file-pdf-o"></i> Cetak</a>
                                    </div>
                                </div>   
                                <!-- END Rekap Gaji PTT SPMU-->
								
								
								<!--Listing Gaji PTT Disdik -->
                                <div id="paramval5" style="display: none">
                                    ...
                                    <div class="col-md-3">
                                        <a onclick="cetakgajipttdisdik(); return false;" id="btnPdf" class="btn btn-danger"><i class="fa fa-file-pdf-o"></i> Cetak</a>
                                    </div>
                                </div>    
                                <!-- Listing Gaji PTT Disdik-->
								
								<!--Rekap Gaji PTT Disdik -->
                                <div id="paramval6" style="display: none">
                                    ...
                                    <div class="col-md-3">
                                        <a onclick="cetakrekapgajipttdisdik(); return false;" id="btnPdf" class="btn btn-danger"><i class="fa fa-file-pdf-o"></i> Cetak</a>
                                    </div>
                                </div>   
                                <!-- END Rekap Gaji PTT Disdik-->
    ...
    <!-- END WELLCOME -->
        ...
        $(document).ready(function(){
			...
			function cetaklistinggajiptt()
            {
                var thblleng= $('#thbl1').val().length;
                var thbl= $('#thbl1').val();
                if( thblleng >0)
                {
                    window.open('<?=site_url('listing')?>/cetaklistinggajiptt/'+thbl);
                }
                else
                {
			...
			function cetakrekapgajipttgab()
            {
                var thblleng= $('#thbl2').val().length;
                var thbl= $('#thbl2').val();
                if( thblleng >0)
                {
                    window.open('<?=site_url('listing')?>/cetakrekapgajipttgab/'+thbl);
                }
                else
                {
                    alert('THBL Harap Diisi');
			...
			function cetaklistinggajipttspm()
            {
                ...
                {
                    window.open('<?=site_url('listing')?>/cetaklistinggajipttspm/'+thbl+'/'+skpd);
                }
				
            }
			
			function cetakrekapgajipttspm()
            {
                ...
                {
                    window.open('<?=site_url('listing')?>/cetakrekapgajipttspm/'+thbl+'/'+skpd);
                }
				
            }
			
			function cetakgajipttdisdik()
            {
                var thblleng= $('#thbl5').val().length;
                var thbl= $('#thbl5').val();
                if( thblleng >0)
                {
                    window.open('<?=site_url('listing')?>/cetakgajipttdisdik/'+thbl);
                }
                else
                {
                    alert('THBL Harap Diisi');
			...
			function cetakrekapgajipttdisdik()
            {
                var thblleng= $('#thbl6').val().length;
                var thbl= $('#thbl6').val();
                if( thblleng >0)
                {
                    window.open('<?=site_url('listing')?>/cetakrekapgajipttdisdik/'+thbl);
                }
                else
                {
                    alert('THBL Harap Diisi');
