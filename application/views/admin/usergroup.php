        ...
        $(document).ready(function() {
             ...
             var dataTable = $('#tbl_groupUser').DataTable( {
                        ...
                        "ajax":{
                            ...
                            url: "<?php echo base_url(); ?>index.php/admin/admin/getGroup",
                            ...
                            error: function(){  // error handling
                                ...
                                $("#tbl_groupUser").append('<tbody class="employee-grid-error"><tr><th colspan="3">No data found in the server</th></tr></tbody>');
                                $("#tbl_groupUser_processing").css("display","none");
